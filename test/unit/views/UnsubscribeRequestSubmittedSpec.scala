...
class UnsubscribeRequestSubmittedSpec extends UnitSpec with GuiceOneServerPerSuite with MockitoSugar {
  "Unsubscribe request submitted page" should {
    "render with no errors" in {
      ...
      val page = views.html.unsubscribeRequestSubmitted.render(application, apiName, apiVersion, request, developer, messages, appConfig, "subscriptions")
